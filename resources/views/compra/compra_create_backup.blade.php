...
<div class="container">
    ...
    <form action="{{ route('compras.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="numero_compra" name="numero_compra" class="form-control" value="{{ old('numero_compra') }}" required>
            @error('numero_compra')
        ...
        <div class="form-group">
            ...
            <input type="number" id="monto" name="monto" class="form-control" value="{{ old('monto') }}" step="0.01" required>
            @error('monto')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
