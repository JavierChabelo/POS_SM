        ...
        <form action="{{ route('subcategorias.update', $subcategoria->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre_subcategoria" id="nombre_subcategoria" 
                 class="form-control" value="{{ old('nombre_subcategoria', $subcategoria->nombre_subcategoria) }}" required maxlength="255">
            ...
            <div class="form-group">
                ...
                @if ($subcategoria->imagen)
                    <div class="mt-2">
                        <img src="{{ asset('storage/'.$subcategoria->imagen) }}" alt="Imagen" class="imagen">
                    </div>
                @endif
            </div>

            <button type="submit" class="btn btn-success">Actualizar Subcategoría</button>
        </form>
    </div>
</div>
@endsection
